...
GRAPH_RULES: List[GraphRule] = [
    ...
    GraphRule("pregnancy_bleeding", ["pregnancy bleeding", "pregnant bleeding", "bleeding in pregnancy"], "emergency", "Bleeding during pregnancy is a maternal danger sign.", "Urgent maternal referral and notify supervisor."),
